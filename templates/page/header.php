...
<?php
$darkmode = '';
if(!empty($_GET['darkmode'])){
    $darkmode = 'c-darkmode';
}
?>
<body <?php body_class($darkmode); ?> >

<!-- header-->
<header class="c-header <?=  do_shortcode("[c_option key='sticky_header']")? 'c-header-sticky':'c-header-sticky'; ?>" role="banner">
    
    <!-- header inner-->
    <div class="c-container c-container-no-padding c-header-inner c-row-justify-center">
